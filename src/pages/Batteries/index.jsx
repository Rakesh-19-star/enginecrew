      ...
      <section className="batteries-page">
        ...
        <section className="hero-section">
          <div className="hero-content">
            ...
            <p className="hero-subtitle">
              Get genuine Exide & Amaron batteries delivered and installed at
              your location.
              <strong>
                {" "}
        ...
        {!selectedFuel && (
          <div className="empty-state">
            ...
            <p>
              Please select your car brand, model and fuel type to view
              available batteries
            </p>
          </div>
        )}
        ...
        {selectedFuel && (
          <>
            <div className="results-header">
              ...
              <p>
                {batteries.length}{" "}
                {batteries.length === 1 ? "option" : "options"} found
              </p>
            </div>
            ...
            <div className="battery-grid">
              {batteries.map((battery, index) => {
                ...
                const batteryImage = battery.brand
                  .toLowerCase()
                  .includes("exide")
                  ? exideBattery
                  : amaronBattery;
